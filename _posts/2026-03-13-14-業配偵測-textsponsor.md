...
<div class="mermaid">
timeline
    title TextSponsor 演進時間線
    section 起步
        pre-2022 : v1 繁體中文 : IG + FB
    section 多語言擴展
        2023 Q1 : 日文上線 : 獨立 EDA
        2023 Q2-Q3 : 越/英/泰/馬 : 六語言全上線 (9/14)
    section 平台擴展
        2024 : YouTube + Twitter + TikTok : 五平台覆蓋
</div>
...
<div class="mermaid">
graph LR
    TL[TextLangID<br/>語言偵測] --> TS[TextSponsor<br/>是否業配？]
    TS --> SPDA[SPDA<br/>歸因品牌]
    SPDA --> TK[TextKnowledge<br/>品牌+商品萃取]
    TK --> ALS[ALS 推薦系統]
    TK --> KD[KOL 詳情頁<br/>業配歷史]
    TK --> BQ[BigQuery<br/>分析數據]
    style TL fill:#94a3b8,color:#fff
    style TS fill:#6366f1,color:#fff
    style SPDA fill:#8b5cf6,color:#fff
    style TK fill:#3b82f6,color:#fff
    style ALS fill:#10b981,color:#fff
    style KD fill:#10b981,color:#fff
